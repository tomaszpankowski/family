...
class PackageS4 extends Component{
    render(){
        return(    
            <Container fluid className="package-s4 d-flex minh-50vh align-items-center py-5 border-top border-secondary bg-secondary">
