...
class PackageS2 extends Component{
    render(){
        return(    
            <Container fluid className="package-s2 d-flex bg-secondary minh-50vh align-items-center py-5 border-top border-secondary">
