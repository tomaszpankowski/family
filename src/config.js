...
const appCfg = {
    routes:[
        ...
        {navItem:true, exact:true, path:"/package",name:"Package",view:<Package/>},
...
const APP_LINKS = {
    messages: "http://localhost/family/public/message.php",
    register: "register.php",
    users: "http://localhost/family/public/user.php"
};
